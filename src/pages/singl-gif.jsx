...
const SinleGif = () => {
  ...
  const { gf, addToFavorites, favorite } = Gifstate();
  ...
  useEffect(() => {
    ...
    fetchGif();
  }, [slug,data]);  // slug change page refresh (for related gif)
        ...
        <div className="flex gap-6">
          ...
          <div className="hidden sm:flex flex-col gap-5 mt-6">
            ...
            >
              <HiMiniHeart
                size={30}
                className={`${favorite.includes(gif.id) ? "text-red-500" : ""
                  }`}
              />
              Favorite
            </button>
